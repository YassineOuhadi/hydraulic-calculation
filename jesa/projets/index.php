...
elseif(isset($_POST['btn_NewProjet'])){
    ...
    header('HTTP/1.1 303 See Other');
    header("location:http://localhost/jesa/projets/index.php?projet=$id");
};
...
<head>
     ...
     <link rel="stylesheet" href="../lignes/array.css">
	 <title>
     <?php 
						...
						<tbody style="margin-top:5px;">
                            ...
                            foreach($trajets as $trajet){
				                ...
				                <tr onclick="move();" onchange="check();" id="tr<?php echo $k; ?>">
                                    ...
                                    <td>
                                        <a href="../lignes/index.php?i=<?php echo $trajet->idTrajet; ?>" class="button-26" role="button">Plus
                                        </a>
                                    </td>	
								</tr>
                                <?php ;}; ?>
