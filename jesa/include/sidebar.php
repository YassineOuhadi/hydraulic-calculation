...
<section id="sidebar">
		...
		<ul class="side-menu">
			<li>
            <a href="../Dashboard/index.php" class="active"><i class='bx bxs-dashboard icon' style="color:white;"></i> 
            ...
            >
                <a href="../Dashboard/index.php?projet=<?php echo $row['id_projet']; ?>" id="projet<?php echo $i; ?>">
