	...
	<section id="content">
		...
		<main>
            ...
            <div class="head-title" >
				<div class="left">
					<a href="../Dashboard/index.php?projet=<?php echo $id_projet; ?>"><h1 id="projet"></h1></a>
					<ul class="breadcrumb">
				        <li>
                             <a id="trajet" href="#"></a>
                        </li>
            ...
            <div class="content-data">
                ...
                <div class="pricing-wrapper">
                   ...
                   <div class="pricing-box" style="height:300px;background: url(../Dashboard2/images/hh.png);background-size:cover;"></div>
